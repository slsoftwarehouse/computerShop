...
public class SamplePK implements Serializable {
    ...
    public SamplePK(String id, String customer) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SamplePK)) {
            return false;
        }
        SamplePK other = (SamplePK) object;
    ...
    public String toString() {
        return "com.cs.dao.SamplePK[ id=" + id + ", customer=" + customer + " ]";
    }
